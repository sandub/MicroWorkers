...
class paypal_class {
   ...
   function submit_paypal_post() 
   {
      ...
      echo "<html>\n";
      echo "<head><title>PayPal.com - Processing Your Order.....</title></head>\n";
      echo "<body onLoad=\"document.forms['paypal_form'].submit();\" bgcolor='#CFCFCF'>\n";
      echo "<center><br/><br/><br/><br/>";
	  echo "<font color='#000000' size='+1' face='Verdana'><b>Please wait while your order is being processed.... You";
      echo " are being redirected to PayPal's Secure Website....</b></font></center>\n";
      ...
      echo "<center><br/><br/><font color='#cc0000' size='-2' face='Verdana'>If you are not automatically redirected to ";
      echo "PayPal within 5 seconds...</font><br/><br/>\n";
