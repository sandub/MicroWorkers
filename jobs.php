...
dbQuery("insert into `user_hidden_jobs`(`email`,`jobid`) values('".$_SESSION["userlogin"]."','".base64_decode($_GET["Id"])."')");
	...
	header("location: jobs.php?Sort=".$_GET["s"]);
...
$sql2=dbQuery("select * from `jobs` where `status`='1' and `homepage`='1' and `status`<>'3' and `country`='$UC' and `id` not in (select `jobid` from `user_hidden_jobs` where `email`='".$_SESSION["userlogin"]."')");

} else {

$sql2=dbQuery("select * from `jobs` where `status`='1' and `homepage`='1' and `status`<>'3' and `id` not in (select `jobid` from `user_hidden_jobs` where `email`='".$_SESSION["userlogin"]."')");
...
$sql=dbQuery("select * from `jobs` where `status`='1' and `homepage`='1' and `status`<>'3' and `country`='$UC' and `id` not in (select `jobid` from `user_hidden_jobs` where `email`='".$_SESSION["userlogin"]."') ORDER BY `price` desc");

} else {

$sql=dbQuery("select * from `jobs` where `status`='1' and `homepage`='1' and `status`<>'3' and `id` not in (select `jobid` from `user_hidden_jobs` where `email`='".$_SESSION["userlogin"]."') ORDER BY `price` desc");
...
$sql=dbQuery("select * from `jobs` where `status`='1' and `homepage`='1' and `status`<>'3' and `country`='$UC' and `id` not in (select `jobid` from `user_hidden_jobs` where `email`='".$_SESSION["userlogin"]."') ORDER BY `id` desc");

} else {

$sql=dbQuery("select * from `jobs` where `status`='1' and `homepage`='1' and `status`<>'3' and `id` not in (select `jobid` from `user_hidden_jobs` where `email`='".$_SESSION["userlogin"]."') ORDER BY `id` desc");
	...
	$sql=dbQuery("select * from `jobs` where `status`='1' and `homepage`='1' and `status`<>'3' and `country`='$UC' and `id` not in (select `jobid` from `user_hidden_jobs` where `email`='".$_SESSION["userlogin"]."') ORDER BY ".$key." ".$sort." ");

	} else {

	$sql=dbQuery("select * from `jobs` where `status`='1' and `homepage`='1' and `status`<>'3' and `id` not in (select `jobid` from `user_hidden_jobs` where `email`='".$_SESSION["userlogin"]."') ORDER BY ".$key." ".$sort." ");
	...
	$sql=dbQuery("select * from `jobs` where `status`='1' and `homepage`='1' and `status`<>'3' and `country`='$UC' and `id` not in (select `jobid` from `user_hidden_jobs` where `email`='".$_SESSION["userlogin"]."') ORDER BY `started` desc");

	} else {

	$sql=dbQuery("select * from `jobs` where `status`='1' and `homepage`='1' and `status`<>'3' and `id` not in (select `jobid` from `user_hidden_jobs` where `email`='".$_SESSION["userlogin"]."') ORDER BY `started` desc");
...
window.location.href='jobs.php?Id='+a+'&ac='+h+'&s=<?php echo $_GET["Sort"]; ?>';

<?php } else { ?>

window.location.href='jobs.php?Id='+a+'&ac='+h;
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                 ...
                 <tr>                   
                   ...
                   <td width="600" valign="top" align="left">
						...
						<b><?php echo $countjobs2; ?> Jobs Running &amp; Available to You.</b><br /><font color="#DD3333">

						<b><?php echo $FeePerCompletedJob; ?>% Transaction Fee Per Completed Job.</b></font><br />
						...
						<input type="checkbox" name="jobmailUSA" id="jobmailUSA" value="1" <?php if($jobeUI["jobmailUSA"]=='1') { echo 'checked="checked"'; } ?> onclick="window.location.href='jobs.php?jobmailUSA=<?php echo ($jobeUI["jobmailUSA"]==0)?1:0; ?>'" /></td>
						...
						<input type="checkbox" name="jobmailINT" id="jobmailINT" value="1" <?php if($jobeUI["jobmailINT"]=='1') { echo 'checked="checked"'; } ?> onclick="window.location.href='jobs.php?jobmailINT=<?php echo ($jobeUI["jobmailINT"]==0)?1:0; ?>'" /></td>
			  ...
			  <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>                       
					   ...
					   <a href="jobs.php?key=title&sort=asc"><img src="images/up.gif" border="0"></a> 

					   <a href="jobs.php?key=title&sort=desc"><img src="images/down.gif" border="0"></a></span></td>                       

                       <td width="10%" style="font-weight:bold;">Started<br />

						<a href="jobs.php?key=started&sort=asc"><img src="images/up.gif" border="0"></a> 

					   <a href="jobs.php?key=started&sort=desc"><img src="images/down.gif" border="0"></a></td>

                       <td width="10%" style="font-weight:bold;">Payment<br />

						<a href="jobs.php?key=price&sort=asc"><img src="images/up.gif" border="0"></a> 

					   <a href="jobs.php?key=price&sort=desc"><img src="images/down.gif" border="0"></a></td>

                       <td width="10%" style="font-weight:bold;">Time<br />

						<a href="jobs.php?key=time&sort=asc"><img src="images/up.gif" border="0"></a> 

					   <a href="jobs.php?key=time&sort=desc"><img src="images/down.gif" border="0"></a></td>

                       <td width="8%" style="font-weight:bold;">Status<br />

                        <a href="jobs.php?key=status&sort=asc"><img src="images/up.gif"	border="0"></a>         

						<a href="jobs.php?key=status&sort=desc"><img src="images/down.gif" border="0"></a></td>

                       <td width="8%" style="font-weight:bold;">Done<br />

						<a href="jobs.php?key=wd1/wd2&sort=asc"><img src="images/up.gif" border="0"></a> 

					    <a href="jobs.php?key=wd1/wd2&sort=desc"><img src="images/down.gif" border="0"></a></td>
			   ...
			   <tr>				
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					...
					<td width="48%" height="28" style="padding-left:10px;" align="left">

					<a href="<?php if($res["status"]=='1') { echo 'jobs_details'; } else { echo 'jobs_details_notrunning'; } ?>.php?Id=<?php echo base64_encode($res["id"]); ?>" style="text-decoration:none; color:#000000;">

					<div style="float:left;"><div style="float:left;"><?php if($res["country"]=='INT') { echo '<img src="images/Globe.png" height="16" width="16" border="0" />&nbsp;&nbsp;'; } else if($res["country"]=='USA') { echo '<img src="images/USFlag.png" height="16" width="16" border="0" />&nbsp;&nbsp;'; }?></div><div style="float:left;padding-top:2px;"><?php if($res["bold"]=='1') { echo '<b>'.$job_title.'</b>'; } else { echo $job_title; } ?></div>

					</a></td>

                   <td width="12%" height="28"><?php $start=strtotime($res["started"]); $end=strtotime($totaldate);	 if( $diff=get_day_difference($start,$end)) {							
                   ...
                   <td width="9%" height="28"> $<?php echo number_format($res["price"], 2); ?></td>

                   <td width="11%" height="28"> <?php echo stripslashes($res["time"]); ?> min</td>
