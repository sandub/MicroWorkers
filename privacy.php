...
$Privacy=mysql_fetch_array(mysql_query("select * from `cms` where `pname`='Privacy'"));
?>
		...
		<td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<td width="100%" align="left" style="font-weight:bold; padding-left:10px;">Privacy Policy</td>
				  </tr>
				</table>
			  ...
			  <tr>				
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					...
					<?php echo stripslashes($Privacy["pcontent"]);?>     
